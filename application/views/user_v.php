...
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		<thead><tr>
			...
			<th style="text-align:center; width:30%">Level</th>
			...
			<?php 
				...
				if(!empty($users)){
					foreach($users as $u){	
						...
						$info = $u['operator_id'].'Þ'.ucwords($this->converter->decode($u['_user'])).'Þ'.$u['fullname'].'Þ'.$u['status'].'Þ'.$u['name'].'Þ'.$u['level'].'Þ'.$this->converter->decode($u['_pass']);					
						$status = null;
						$_level = null;						
						if($u['status'] == 1){
						...
						echo '<td style="vertical-align: middle;">'.$_level.'</td>';
