...
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		<thead><tr>
			...
			<th style="text-align:center; width:18%">Employer</th>			
			<th style="text-align:center; width:18%">Applicant</th>	
			<th style="text-align:center; width:17%">Upload Date</th>			
...
$(function() {
	var path_role= '<?php echo site_url('bukti_payment/load_data');?>';
